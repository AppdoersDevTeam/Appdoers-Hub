...
export function ListToolbar({
  ...
  return (
    <div className={cn('flex flex-wrap items-center gap-2', className)}>
      <div className="relative min-w-[12rem] flex-1 basis-48">{search}</div>
        ...
        <div ref={wrapRef} className="relative">
          ...
          {open ? (
            <div
              ...
              className="absolute left-0 top-full z-50 mt-1 flex min-w-[14rem] flex-col gap-2 rounded-md border border-slate-200 bg-white p-3 shadow-lg"
            >
              {secondaryFilters}
            </div>
          ) : null}
