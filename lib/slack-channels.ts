...
export const SLACK_CHANNEL_DESCRIPTIONS: Record<SlackChannel, string> = {
  ...
  billing: 'Invoice paid, subscription and domain renewal reminders (1 month, 1 week, day of), billing alerts',
  tasks: 'New tasks, status changes, Hub field edits, project moves, and deletes',
