...
export const COLOR_PALETTES: ColorPalette[] = [
  {
    id: 'coastal',
    name: 'Coastal',
    description: 'Sea blues and sand',
    colors: {
      primary: '#0F4C81',
      secondary: '#7FA7BE',
      accent: '#E8B86D',
  ...
  },
  {
    id: 'ink',
    name: 'Ink',
    description: 'Near-black and paper',
    colors: {
      primary: '#111827',
      secondary: '#4B5563',
      accent: '#2563EB',
  ...
  },
  {
    id: 'bold-coral',
    name: 'Bold Coral',
    description: 'High-energy contrast',
    colors: {
      primary: '#1A1A1A',
      secondary: '#5C5C5C',
      accent: '#E85D4C',
  ...
  },
  {
    id: 'soft-sage',
    name: 'Soft Sage',
    description: 'Calm greens and linen',
    colors: {
      primary: '#3F5D50',
      secondary: '#8AA396',
      accent: '#D4A373',
  ...
  },
  {
    id: 'sunset',
    name: 'Sunset',
    description: 'Terracotta and dusk',
    colors: {
      primary: '#6B2D39',
      secondary: '#C97B63',
      accent: '#E8A87C',
...
export const FONT_PAIRINGS: FontPairing[] = [
  {
    id: 'editorial',
    name: 'Editorial',
    description: 'Serif headlines, clean body',
  ...
  },
  {
    id: 'warm',
    name: 'Warm',
    description: 'Soft serif with friendly sans',
    heading: 'Fraunces',
    body: 'Nunito Sans',
  ...
  },
  {
    id: 'modern',
    name: 'Modern',
    description: 'Geometric and highly readable',
    heading: 'Outfit',
  ...
  },
  {
    id: 'bold',
    name: 'Bold',
    description: 'Strong sans pairing',
  ...
  },
  {
    id: 'luxury',
    name: 'Luxury',
    description: 'Elegant serif with quiet body',
    heading: 'Cormorant Garamond',
    body: 'Mulish',
    headingFamily: '"Cormorant Garamond", serif',
    bodyFamily: 'Mulish, sans-serif',
  },
  {
    id: 'playful',
    name: 'Playful',
  ...
  },
  {
    id: 'minimal',
    name: 'Minimal',
    description: 'Tight, contemporary serif + sans',
...
export const STYLE_MOODS: StyleMood[] = [
  {
    id: 'minimal',
    name: 'Minimal',
    description: 'Lots of space, simple layouts, few colours.',
  },
  {
    id: 'editorial',
    name: 'Editorial',
    description: 'Magazine-like type, strong headlines, photography-led.',
  },
  {
    id: 'bold',
    name: 'Bold',
    description: 'Big type, high contrast, confident and modern.',
  },
  {
    id: 'warm',
    name: 'Warm',
    description: 'Approachable, earthy, human and inviting.',
  },
  {
    id: 'playful',
    name: 'Playful',
    description: 'Friendly shapes, brighter colour, a bit of personality.',
  },
  {
    id: 'luxury',
    name: 'Luxury',
    description: 'Refined, quiet, premium — less is more.',
  },
]
...
export function moodById(id: string | null | undefined) {
  if (!id || id === UNSURE_OPTION_ID) return null
