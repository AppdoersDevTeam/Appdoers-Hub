...
const statusConfig: Record<string, { label: string; cls: string }> = {
  draft: { label: 'On file', cls: 'bg-gray-100 text-gray-600' },
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Download contracts shared by Appdoers.</p>
      </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {c.file_name ?? 'Contract document'} ·{' '}
                      {c.signed_at
                        ? `Signed ${formatDate(c.signed_at)}`
                        : c.sent_at
                          ? `Shared ${formatDate(c.sent_at)}`
